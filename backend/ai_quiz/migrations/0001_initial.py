    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('lecture_slide', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='adaptive_quizzes', to='ai_quiz.lectureslide')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adaptive_quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_progress', to='ai_quiz.adaptivequiz')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('progress', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attempts', to='ai_quiz.studentadaptiveprogress')),
            ],
            options={
                'ordering': ['-started_at'],
            },
